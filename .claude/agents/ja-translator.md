---
name: ja-translator
description: Translate English CSS best-practices MDX docs to Japanese for the zfb i18n locale
---
...
This is a CSS best practices documentation site built with zfb (zudo-doc framework). The docs use MDX format with:
