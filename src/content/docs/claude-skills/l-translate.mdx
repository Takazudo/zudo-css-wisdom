---
title: "l-translate"
description: "Translate English docs to Japanese for the zfb i18n locale. Use when: (1) User wants to translate en docs to ja, (2) User says 'translate', 'ja version', 'Japanese translation', (3) User wants to chec..."
