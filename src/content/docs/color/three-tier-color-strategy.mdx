...
- [Advanced Custom Properties](../custom-properties/index.mdx) — Fallback chains, space toggles, and component APIs that implement the three-tier pattern
- [Theming Recipes](../custom-properties/theming-recipes.mdx) — Production-ready theme recipes using this architecture
- [Color Token Patterns](../design-tokens/tight-token-strategy/color-tokens.mdx) — Applying three-tier tokens in Tailwind's `@theme` system
- [Three-Tier Font-Size Strategy](../font-sizing/three-tier-font-size-strategy.mdx) — The same three-tier architecture applied to font sizes
