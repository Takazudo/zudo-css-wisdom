...
This article covers the mechanics — which property to reach for. For the perceptual reasoning behind *how much* space each side of a boundary should get, see [Spacing Philosophy: Proximity Grouping](../design-principles/spacing-philosophy.mdx).
