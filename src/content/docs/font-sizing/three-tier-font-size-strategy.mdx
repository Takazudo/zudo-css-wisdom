...
This is the same architecture as the [Three-Tier Color Strategy](../color/three-tier-color-strategy.mdx) (palette → theme → component), applied to font sizes.
...
For detailed Tailwind `@theme` configuration, including paired line-heights and weight tokens, see [Typography Token Patterns](../design-tokens/tight-token-strategy/typography-tokens.mdx).
...
This gives you `text-xs` through `text-2xl` utilities. For the full Tailwind configuration including paired line-heights and weight tokens, see [Typography Token Patterns](../design-tokens/tight-token-strategy/typography-tokens.mdx).
...
- [Typography Token Patterns](../design-tokens/tight-token-strategy/typography-tokens.mdx) — Practical `@theme` configuration for Tier 1 in Tailwind
