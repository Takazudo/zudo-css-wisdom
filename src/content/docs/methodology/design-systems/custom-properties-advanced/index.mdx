...
Create layered configuration systems where a component checks for progressively broader defaults. This is the mechanism behind the [Three-Tier Color Strategy](../../../styling/color/three-tier-color-strategy.mdx) — component tokens fall back to theme tokens, which fall back to palette values.
