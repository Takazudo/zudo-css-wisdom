...
The topic index is generated from all MDX articles under `src/content/docs/` (excluding the `overview/` category), combined with curated descriptions from `.claude/skills/css-wisdom/descriptions.json`.
