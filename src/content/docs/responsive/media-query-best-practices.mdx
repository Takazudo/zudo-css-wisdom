...
description: Use media queries for page-level layout and user preferences with a mobile-first approach.
sidebar_position: 4
---
...
See the dedicated [prefers-reduced-motion](../interactive/forms-and-accessibility/prefers-reduced-motion.mdx) page for a more nuanced approach.
