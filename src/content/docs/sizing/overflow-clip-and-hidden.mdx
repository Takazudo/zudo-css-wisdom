...
You only need to cut paint and nothing should ever scroll: containing decorative bleed, a [letterbox stage](../media/letterbox-stage.mdx), print layouts where scroll containers are meaningless, or oversized background flourishes. `clip` is the cheaper and side-effect-free default for all decorative clipping.
