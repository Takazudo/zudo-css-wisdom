...
<CssPreview
  ...
  css={`    :root {
    ...
    .product-card {
      ...
      border-radius: 12px;
      overflow: hidden;
      box-shadow: 0 4px 16px var(--_card-shadow);
      width: 160px;
      flex-shrink: 0;
    }
    /* Product color variants — only Tier 3 vars change */
    .product-card--ocean {
      --_card-variant: oklch(58% 0.15 230);
      --_card-variant-light: oklch(80% 0.08 230);
      --_card-variant-dark: oklch(40% 0.12 230);
      --_card-shadow: oklch(58% 0.15 230 / 0.25);
    }
    .product-card--sunset {
      --_card-variant: oklch(62% 0.2 50);
      --_card-variant-light: oklch(82% 0.1 50);
      --_card-variant-dark: oklch(42% 0.15 50);
      --_card-shadow: oklch(62% 0.2 50 / 0.25);
    }
    .product-card--forest {
      --_card-variant: oklch(55% 0.15 150);
      --_card-variant-light: oklch(78% 0.08 150);
      --_card-variant-dark: oklch(38% 0.12 150);
      --_card-shadow: oklch(55% 0.15 150 / 0.25);
    }
    .product-card__badge {
      background: linear-gradient(135deg, var(--_card-variant), var(--_card-variant-dark));
...
<CssPreview
  ...
  css={`    :root {
    ...
    /* ===== Tier 3: Component ===== */
    .demo-btn--primary {
      --_btn-shadow: oklch(58% 0.2 250 / 0.3);
    }
    .full-demo {
      display: grid;
      grid-template-columns: 1fr 1fr;
    ...
    .demo-btn--primary {
      background: var(--theme-accent);
      color: var(--theme-accent-fg);
      box-shadow: 0 2px 8px var(--_btn-shadow);
    }
    .demo-btn--outline {
...
.btn {
  ...
  --_btn-shadow: oklch(from var(--theme-accent) l c h / 0.3);
...
For a deep dive into dark mode techniques, see [Dark Mode Strategies](./dark-mode-strategies.mdx).
...
- **Dark mode** — dark mode is just another Tier 2 mapping (see [Dark Mode Strategies](./dark-mode-strategies.mdx))
...
- [Color Palette Strategy](./color-palette-strategy.mdx) — How to choose and generate palette colors (Tier 1)
- [Dark Mode Strategies](./dark-mode-strategies.mdx) — Dark mode techniques that work with Tier 2 token swapping
- [Advanced Custom Properties](../../methodology/design-systems/custom-properties-advanced/index.mdx) — Fallback chains, space toggles, and component APIs that implement the three-tier pattern
- [Theming Recipes](../../methodology/design-systems/custom-properties-advanced/theming-recipes.mdx) — Production-ready theme recipes using this architecture
- [Color Token Patterns](../../methodology/design-systems/tight-token-strategy/color-tokens.mdx) — Applying three-tier tokens in Tailwind's `@theme` system
- [Three-Tier Font-Size Strategy](../../typography/font-sizing/three-tier-font-size-strategy.mdx) — The same three-tier architecture applied to font sizes
