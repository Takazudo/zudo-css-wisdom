...
This is the same architecture as the [Three-Tier Color Strategy](../../../styling/color/three-tier-color-strategy/) (palette → theme → component), applied to font sizes.
...
For detailed Tailwind `@theme` configuration, including paired line-heights and weight tokens, see [Typography Token Patterns](../../../methodology/design-systems/tight-token-strategy/typography-tokens/).
...
This gives you `text-xs` through `text-2xl` utilities. For the full Tailwind configuration including paired line-heights and weight tokens, see [Typography Token Patterns](../../../methodology/design-systems/tight-token-strategy/typography-tokens/).
...
- [Typography Token Patterns](../../../methodology/design-systems/tight-token-strategy/typography-tokens/) — Practical `@theme` configuration for Tier 1 in Tailwind
